...
const PersonCard: React.FC<PersonCardProps> = ({
  ...
  return (
    <div
      className={clsx(
        "relative border-[#f7f7f7] border-t-2 w-full overflow-hidden hover:bg-gray-100 cursor-pointer",
        { "bg-gray-50": selectedDiscussion === name }
      )}
      onClick={() => setSelectedDiscussion(name)}
    >
