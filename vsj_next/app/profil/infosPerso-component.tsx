...
const InfosPersoComponent = () => {
    ...
    const fetchUser = async () => {
      try {
        ...
        if (response.ok) {
          ...
          console.error("Erreur de récupération des informations utilisateur:", data.message);
        }
      } catch (error) {
  ...
  return (
    ...
    >
      ...
      <H4 className="mb-1 text-xxs">Informations personnelles</H4>

      <main className="h-full w-full grid grid-cols-2 grid-rows-4 gap-y-0.5">
        <HForm className="row-start-1 col-start-1 self-center text-xxs">Nom complet</HForm>
        ...
        <HForm className="row-start-2 col-start-1 self-center text-xxs">Prénom</HForm>
        ...
        <HForm className="row-start-3 col-start-1 self-center text-xxs">Date de naissance</HForm>
        ...
        <HForm className="row-start-4 col-start-1 self-center text-xxs">Adresse</HForm>
        ...
        <HForm className="row-start-5 col-start-1 self-center text-xxs">Code Postal</HForm>
        ...
        <HForm className="row-start-6 col-start-1 self-center text-xxs">Ville</HForm>
        ...
        <HForm className="row-start-7 col-start-1 self-center text-xxs">Téléphone</HForm>
